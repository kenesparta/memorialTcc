...
\begin{document}
	...
	\newcommand*\tcc{
		...
		\emph{open source}: Scipy, Numpy, Matplotlib e Jupyter. Uma breve
		explicação sobre o funcionamento daquelas bibliotecas é exposta a
		seguir:
		...
		Web são utilizados os algoritmos Subject Detection e Node Density
		...
		o MongoDB) e analisam-se, juntamente com os dados dos Web logs da
		Wikipédia, utilizando uma técnica de rede neural com aprendizagem
		supervisionada. Finalmente, a resposta preparada é mostrada para o
		usuário. Tal resposta contém links de páginas Web de artigos acadêmicos
		que estão relacionados com as palavras-chave da busca.
		...
		\begin{table}[H]
			...
			\begin{tabular}{>{\centering}m{5.3cm}>{\centering}m{5.5cm}}
				...
				\midrule
				Modelagem, avaliação, desenvolvimento e TDD  & 15/08/2016 $\longrightarrow$ 15/09/2016\tabularnewline
				\bottomrule
