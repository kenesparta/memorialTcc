...
\begin{document}
	...
	\newcommand*\tcc{
		...
		\begin{itemize}[leftmargin=1.9cm,labelwidth=2cm,labelindent=1.5em,labelsep=0.55cm]
			...
			dados na Web (Web crawler) e um extrator de textos.
		...
		Python (versão 3.5) utilizando o framework Django. São implementadas,
		na plataforma, as rotinas para a obtenção de dados, pré-processamento,
		agrupamento, análise, obtenção de conhecimento e reconhecimento de
		padrões de artigos relacionados com a Wikipédia e os Web logs dos
		servidores desta.
