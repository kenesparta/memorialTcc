...
\begin{document}
	...
	\newcommand*\tcc{
		...
		Por outra parte, a interface de usuário será desenvolvida para que
		...
		A SC é composta por técnicas como as redes neurais (Neural Network\nomenclature[NN]{NN}{Neural Network}),
		...
		\begin{table}[H]
			...
			\begin{tabular}{>{\centering}m{5.3cm}>{\centering}m{5.5cm}}
				...
				\midrule
				\midrule 
				Compreensão do Projeto  & 01/06/2016 $\longrightarrow$ 14/07/2016\tabularnewline
				\midrule
