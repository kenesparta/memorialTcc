...
\begin{document}
	...
	\newcommand*\tcc{
		...
		as soluções são atingidas imediatamente, por outra parte, a SC lida
		...
		é dada em \cite{shai_2014}, sugere-se que os conceitos de ML devem
		ser utilizados em tarefas realizadas por humanos ou animais. De acordo
		com isso, precisa-se do ML para poder modelar os algoritmos deste
		trabalho; de modo que utilizam-se dados gerados pela interação humana
		com a Web a partir de buscas.
